 ...
 * Обновление: правка массива в теме + deploy (автоматически не подтягивается из документа).
 */
...
function liderdent_render_short_prices( string $modifier = '' ): void {
    ...
    echo '<p class="short-prices__note">Актуальный полный прайс уточняйте у администратора. Обновление цен на сайте — вручную через разработчика.</p>';
    echo '</div>';
}
