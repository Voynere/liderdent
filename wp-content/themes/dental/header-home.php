                    ...
                    <div class="header__top">
                        ...
                        <div class="header__top-mobile">
                            <button class="header__follow-search-hidden header__follow-icon-item" id="follow-search-hidden">
                                <img src="<?php bloginfo('template_url') ?>/assets/img/icons/mobile_search.svg" alt="Поиск">
                            </button>
                            <a href="tel:+73912271343" class="header__follow-phone header__follow-icon-item">
                                <img src="<?php bloginfo('template_url') ?>/assets/img/icons/mobile_phone.svg" alt="Контакты">
                            </a>
                            <button class="header__follow-menu header__follow-icon-item open-mobile-menu">
                                <div class="header__follow-menu-line home"></div>
                                <div class="header__follow-menu-line home"></div>
                            </button>
                        </div>
                    </div>
        ...
        <!-- <div class="popup" id="callbackPopup">
            <div class="popup-content">
                ...
                <form id="callbackForm">
                    ...
                    <input type="tel" onclick="this.setSelectionRange(0,0);" placeholder="+7 (___) ___ __-__" id="phone" name="phone" required>

                    <button type="submit">Отправить</button>
                </form>
                <p class="popup-content__privacy">Нажимая кнопку вы автоматически соглашаетесь с <a href="<?php echo site_url('') ?>/privacy">Политикой обработки персональных данных компании</a></p>
            </div>
        </div> -->
